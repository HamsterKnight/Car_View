<template>
  <div class="hobbies-article-detail">
    <div class="hobbies-common-head">
      <common-head></common-head>
    </div>
    <div class="hobbies-article-content">
      <div class="hobbies-article-content-left">
        <div class="hobbies-article-msg-content"
          v-if="articleObj">
          <div class="hobbies-draft-bg"
            v-if="articleObj.state == 2"></div>
          <div class="hobbies-article-title-wrapper"
            v-if="!articleObj.isHobbies">
            <span class="hobbies-article-type-bg">{{articleObj.articleType == 1 ? '原创' : (articleObj.articleType == 2 ? '转载':'翻译')}}</span>
            <span class="hobbies-article-title">{{articleObj.articleTitle}}</span>
          </div>
          <div class="hobbies-article-author-msg">
            <a :href="`/blogerDetail/${articleObj.authorId}`">
              <img v-if="!avatarSrc"
                class="hobbies-article-author-avatar"
                src="../assets/images/avater-icon.png">
              <img v-if="avatarSrc"
                class="hobbies-article-author-avatar"
                :src="avatarSrc" />
            </a>
            <span class="hobbies-article-author-name">{{articleObj.author}}</span>
            <span class="hobbies-line"></span>
            <span class="hobbies-article-author-channel">{{articleObj.channelId == 5 ? '兴趣部落' :articleObj.channelName}}</span>
            <span class="hobbies-article-create-time">发布时间：{{createTime}}</span>
          </div>
          <div class="hobbies-article-content-detail">
            <div class="hobbbies-coursel-wrapper">
              <hobbies-coursel :pic-list="articleObj.picList"></hobbies-coursel>
              <div>{{articleObj.articleContent}}</div>
            </div>

            <div class="hobbies-article-tag-wrapper">
              <span class="hobbies-tip">标签</span>
        ...
        <!-- <div class="hobbies-article-hot-msg">
          <div class="hobbies-article-hot-msg-title">
            <span class="hobbies-hot-msg-bg">热点资讯</span>
          </div>
          <div class="hobbies-article-hot-article-list">
            <div :class="['hobbies-article-hot-article-item', (index == 3 || index == 7) ? 'margin-right0' : '', index <= 3? 'margin-bottom-10px': '']"
              v-for="(item, index) in 8"
              :key="index">
              <img src="../assets/images/banner.png"
                alt="">
              <div class="hobbies-msg">
                <div class="hobbies-title">广汽本田建新能源工厂广汽本田源工厂广汽本田</div>
                <div class="hobbies-author-msg">
                  <img src="../assets/images/banner.png"
                    alt="">
                  <span class="hobbies-name">橙子</span>
                  <span class="hobbies-line"></span>
                  <span class="hobbies-channel">兴趣部落</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="hobbies-article-content-right">
        <div class="hobbies-bloger-msg"
          v-if="authorMsg">
          <div class="hobbies-bloger-right-bottom-bg"></div>
          ...
          <span class="hobbies-name">{{authorMsg.author}}</span>
          <div class="hobbies-bloger-operate">
            <span :class="[ 'hobbies-focus',focusFlag ? '' :'hobbies-btn']"
              @click="isFocusBloger">{{focusTip}}</span>
          </div>
          <div class="hobbies-bloger-count">
            <div class="hobbies-count">
              <div class="hobbies-tip">粉丝</div>
              <div class="hobbies-number">{{authorMsg.fensCount}}</div>
            </div>
            <div class="hobbies-count">
              <div class="hobbies-tip">关注</div>
              <div class="hobbies-number">{{authorMsg.focusCount}}</div>
            </div>
            <div class="hobbies-count">
              <div class="hobbies-tip">文章</div>
              <div class="hobbies-number">{{authorMsg.articleCount}}</div>
            </div>

          </div>
        </div>
        <div class="hobbies-bloger-other-msg">
          <div class="hobbies-bloger-ohter-msg-title">
            <div class="hobbies-ohter-msg-title-content"><span class="hobbies-tip">热门文章</span>
              <!-- <span class="operate">换一换</span> -->
            </div>
            <div class="hobbies-bloger-article-list">
              <div class="hobbies-item"
                v-for="(item, index) in hotArticleList"
                :key="index">
                <a :href="item.isHobbies ? `/hobbiesArticleDetail/${item._id}`:`/articleDetail/${item._id}`">
                  <div class="hobbies-item-img">
                    <img :src="`${path}${item.articlePic}`"
                      alt="">
                  </div>
                  <div class="hobbies-item-msg">
        ...
        <div class="hobbies-bloger-other-msg">
          <div class="hobbies-bloger-ohter-msg-title">
            <div class="hobbies-ohter-msg-title-content"><span class="hobbies-tip">更多作品/随机推荐</span><span class="hobbies-operate">换一换</span></div>
            <div class="hobbies-bloger-article-list">
              <div class="hobbies-item"
...
import hobbiesCourse from "@/components/hobbiesCoursel.vue";
...
export default {
  ...
  async created() {
    ...
    this.authorMsg = result.data.data;
  ...
  computed: {
    avatarSrc() {
      return this.articleObj.autherMsg
        ? path + this.articleObj.autherMsg.avatar
        : "";
    },
    createTime() {
  ...
  .hobbies-article-content {
    ...
    .hobbies-article-content-left {
      ...
      .hobbies-article-msg-content {
        ...
        .hobbies-article-title-wrapper {
          width: 710px;
          line-height: 32px;

          .hobbies-article-type-bg {
            margin-right: 8px;
        ...
        .hobbies-article-author-msg {
          margin-top: 20px;
          overflow: hidden;

          a {
            .hobbies-article-author-avatar {
              margin-right: 6px;
              width: 25px;
              height: 25px;
              border-radius: 50%;
          ...
          .hobbies-article-author-channel {
            font-size: 14px;
            font-weight: 300;
            color: rgba(177, 177, 177, 1);
            line-height: 25px;
          }
          .hobbies-article-create-time {
            float: right;
            font-size: 14px;
            font-weight: 300;
            color: rgba(177, 177, 177, 1);
        ...
        .hobbies-article-content-detail {
          position: relative;
          margin-top: 36px;
          width: 710px;
          line-height: 26px;
      ...
      .hobbies-article-hot-msg {
        ...
        .hobbies-article-hot-article-list {
          .hobbies-article-hot-article-item {
            margin-right: 10px;
            display: inline-block;
            width: 190px;
            height: 218px;
    ...
    .hobbies-article-content-right {
      ...
      .hobbies-bloger-msg {
        ...
        text-align: center;
        background-color: #fff;
        .hobbies-bloger-right-bottom-bg {
          position: absolute;
          box-sizing: border-box;
          right: -10px;
          bottom: -10px;
      ...
      .hobbies-bloger-other-msg {
        margin-top: 45px;
        .hobbies-bloger-ohter-msg-title {
          .hobbies-ohter-msg-title-content {
            position: relative;
            overflow: hidden;
            margin-bottom: 19px;
            .hobbies-tip {
